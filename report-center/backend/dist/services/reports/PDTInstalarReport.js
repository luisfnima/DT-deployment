...
exports.PDTInstalarReport = void 0;
const helpers_1 = require("./helpers");
class PDTInstalarReport {
    async run(crmService) {
        ...
        const filtered = rawSales.filter((v) => {
            ...
            if ((v.status || '').toUpperCase() !== 'PDT DE INSTALAR')
                return false;
            // Rule 2: if has install date, it must be >= today
            if (!v.cabecera_f_instalacion)
                return true;
...
exports.PDTInstalarReport = PDTInstalarReport;
