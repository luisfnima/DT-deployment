...
exports.VentasMesBOReport = void 0;
const helpers_1 = require("./helpers");
class VentasMesBOReport {
    async run(crmService) {
        ...
        const ventasMes = rawSales.filter((s) => s.sale_date && s.sale_date.substring(0, 7) === anioMes);
        ...
        const porSupervisorRaw = (0, helpers_1.agruparPor)(ventasMes, (v) => v.supervisor || 'Sin supervisor');
...
exports.VentasMesBOReport = VentasMesBOReport;
